...
class Robot_System:
    def __init__(self):
        ...
        self.now_place = 1
        self.gemini_serial=['CP1E54200015', 'CP156410008T']

    def get_qrcode_xyz(self, aruco_id_need, gemini_id):
        """
        获取指定Aruco标签的XYZ坐标。
        ...
        """
        # 初始化相机
        arucotag_config_path = "/home/hn/One-shot-imitation-in-chemistry-lab-main/eye/arucotag/arucotag.yaml"
        render_option_path = "/home/hn/One-shot-imitation-in-chemistry-lab-main/eye/arucotag/render_option.json"
...
if __name__ == "__main__":
    ...
    # time.sleep(1)
    # robot.MoveGripper(1, 10, 50, 30, 10000, 1)
    # time.sleep(3)
    ...
    robot_system.get_qrcode_xyz(aruco_id_need, 0)
    # object_id = 0
