...
class Gemini335(Camera):
	...
	def init_pipeline(self):
		...
		# 	test_color_profile = color_profile_list.get_stream_profile_by_index(i)
		# 	for profile in test_color_profile:
		# 	    print(test_color_profile)
		...
		#测试
		for i in len(depth_profile_list):
			test_depth_profile = depth_profile_list.get_stream_profile_by_index(i)
			print(test_depth_profile)
...
if __name__ == "__main__":
	...
	print(f"[INFO] 相机内参: {intrinsic}")
	
	# 获取相机畸变系数
	distortion = camera.get_distortion()
	print(f"[INFO] 相机畸变系数: {distortion}")
